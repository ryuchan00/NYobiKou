...
function addTrackingCookie(cookies, userName) {
    const requestedTrakignId = cookies.get(trackingIdKey);
    if (isValidTrackingId(requestedTrakignId, userName)) {
        return requestedTrakignId;
    } else {
...
function createValidHash(originalId, userName) {
    ...
    //最終的にそのメッセージダイジェストを、 16 進数の文字列として取得しています。
